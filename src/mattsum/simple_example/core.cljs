...
(def logo-img (js/require "../../assets/cljs.png"))

(defn alert [title]
      (.alert (.-Alert ReactNative) title))

(defonce app-state (atom {:greeting "Hello 1Clojure in iOS and Android!"}))
...
(defn init []
      (mount-app)
      (.registerComponent app-registry "SimpleExampleApp" (fn [] root-component-factory)))
